...
![The Split Tally landing page painting itself in, the wordmark, the headline "Finance without forms", and the jellyfish mascot drifting beside it](./static/img/screens/landing-hero.gif)
...
![The Split Tally dashboard showing what Ana is owed and what she owes in serif figures, her groups, the weekly tally prompt, and the orb docked in the bottom right corner](./static/img/screens/dashboard.png)
...
- **[Problem and Solution](./problem-and-solution.md)**: why splitting money with friends is
  forms, what the incumbents get wrong, and the three moves that answer it.
- **[Judging Alignment](./judging-alignment.md)**: one section per criterion, with the file paths
  and numbers behind each claim. Start here if you are grading.
- **[AI Integration](./how-it-works/ai-integration.md)**: every AI touchpoint, the model, the
  transport, and what it writes to the ledger.
- **[Architecture](./how-it-works/architecture.md)**: routes, server actions, the two ElevenLabs
  transports, and where the service-role client is used.
- **[The Ledger](./how-it-works/the-ledger.md)**: the pairwise balance arithmetic, netting, the
  Tally Score, and what an Exchange sale does to all three.
- **[User Flows](./using-it/user-flows.md)**: every screen, walked through.
- **[Setup and Deployment](./using-it/setup-and-deployment.md)**: run it yourself.
- **[Design System](./project/design-system.md)**: "Ink on Cream", the strokes, the tally marks
  and the orb.
- **[Quality](./project/quality.md)**: the QA pass, what it found, and what was fixed.
- **[Roadmap](./project/roadmap.md)** and **[Team](./project/team.md)**.
