...
This page is the map. [AI Integration](../how-it-works/ai-integration.md) covers what the models do,
and [The Ledger](../how-it-works/the-ledger.md) covers the money maths.
...
- `settlements.kind` is a check constraint with exactly three values, and `lib/ledger.ts` treats all
  ...
  explained in [The Ledger](../how-it-works/the-ledger.md).
...
[AI Integration](../how-it-works/ai-integration.md).
