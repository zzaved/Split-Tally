...
![A group page showing who owes whom, with amounts in cobalt and vermilion and worded either way](/img/screens/group-balances.png)
...
![The simplified settlement plan showing two transfers instead of six](/img/screens/group-simplified.png)
...
![The score page showing the tally mark dial, each scoring line with its delta, and the settlement history](/img/screens/score-breakdown.png)
...
![The exchange legend explaining the improving flag alongside a listing that carries it](/img/screens/exchange-improving.png)
