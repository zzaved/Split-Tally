...
![The Split Tally voice sheet open over the dashboard, the orb glowing as it listens, a live caption beneath it and Yes and Fix that chips under the assistant's confirmation line](/img/screens/voice-sheet.gif)
...
![The Split Tally exchange page, a row of listing cards each showing the debtor's initial, their tally score in tally marks, the face value, the asking price, the discount percentage and a chip reading AI fair price](/img/screens/exchange.png)
